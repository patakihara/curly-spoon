...
const PATHS: Record<IconName, string> = {
  ...
  forward_30:
    'M12 5V1l6 5-6 5V7a5 5 0 1 0 5 5h2a7 7 0 1 1-7-7zM9.6 10.4h1.3v4.2H9.9v-3.2l-.9.5v-.9zM13.4 10.4c.9 0 1.5.8 1.5 2.1s-.6 2.1-1.5 2.1-1.5-.8-1.5-2.1.6-2.1 1.5-2.1zm0 .9c-.3 0-.6.4-.6 1.2s.3 1.2.6 1.2.6-.4.6-1.2-.3-1.2-.6-1.2z',
  replay_30:
    'M12 5V1L6 6l6 5V7a5 5 0 1 1-5 5H5a7 7 0 1 0 7-7zM9.6 10.4h1.3v4.2H9.9v-3.2l-.9.5v-.9zM13.4 10.4c.9 0 1.5.8 1.5 2.1s-.6 2.1-1.5 2.1-1.5-.8-1.5-2.1.6-2.1 1.5-2.1zm0 .9c-.3 0-.6.4-.6 1.2s.3 1.2.6 1.2.6-.4.6-1.2-.3-1.2-.6-1.2z',
  speed:
    'M12 3a9 9 0 0 0-7.3 14.3.9.9 0 0 0 1.3.2A7.8 7.8 0 0 1 12 15.8a7.8 7.8 0 0 1 6 2.7.9.9 0 0 0 1.3-.2A9 9 0 0 0 12 3zm.9 4.6-2.7 5a1 1 0 1 0 1.7 1l2.7-5a1 1 0 0 0-1.7-1z',
  sleep_timer:
    'M12 2a1 1 0 0 1 1 1v1.06A8 8 0 1 1 4 12a1 1 0 0 1 2 0 6 6 0 1 0 6-6V8a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1zm5.7 2.3 1.4 1.4-1.1 1.1-1.4-1.4z',
  ...
  more_vert:
    'M12 5a1.8 1.8 0 1 1 0 3.6A1.8 1.8 0 0 1 12 5zm0 5.2a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6zm0 5.2a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6z',
  heart:
    'M12 20.3 10.6 19C5.9 14.7 3 12 3 8.7 3 6 5.1 4 7.7 4c1.5 0 3 .7 3.9 1.8L12 6.3l.4-.5A5.1 5.1 0 0 1 16.3 4C18.9 4 21 6 21 8.7c0 3.3-2.9 6-7.6 10.3z',
  shuffle:
    'M15.3 3.7 21 8l-5.7 4.3v-2.6l-2 .1-2.6-3.4 1.6-2 1.6 2.1 1.4-.1zM3 6h4.4l6 8h4l-.1-2.6L23 15l-5.7 4.3v-2.6h-5.5l-6-8H3z',
  repeat:
    'M6 4h9a5 5 0 0 1 5 5v1h-2V9a3 3 0 0 0-3-3H6.4l1.8 1.8-1.4 1.4L3 5.5 6.8 1.7l1.4 1.4zM18 20H9a5 5 0 0 1-5-5v-1h2v1a3 3 0 0 0 3 3h8.6l-1.8-1.8 1.4-1.4L21 18.5l-3.8 3.8-1.4-1.4z',
  cast: 'M3 5h18v2H5v10H3zM3 15v4h4a4 4 0 0 0-4-4zm0-4v2a6 6 0 0 1 6 6h2a8 8 0 0 0-8-8zm18-6H3v2h16v10h-4v2h6z',
  lyrics:
    'M4 4h14a2 2 0 0 1 2 2v8h-2V6H4v14h8v2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm2 4h10v2H6zm0 4h7v2H6zm10.5 1a3.5 3.5 0 0 1 3.5 3.5V20h-2v-3.5a1.5 1.5 0 0 0-1.5-1.5H16v-2z',
  check: 'M9 16.2 4.8 12l-1.4 1.4L9 19 20.6 7.4 19.2 6z',
  error:
    'M12 2 1 21h22zm0 6.5a1 1 0 0 1 1 1V14a1 1 0 1 1-2 0V9.5a1 1 0 0 1 1-1zM12 16.2a1.2 1.2 0 1 1 0 2.4 1.2 1.2 0 0 1 0-2.4z',
};
