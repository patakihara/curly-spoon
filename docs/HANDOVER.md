...
- **2026-08-05, session `01Wf5C2q`** — wiring `pollDownloads` to a scheduler, so a request's
  download state actually advances in production. Affects both the book and music pipelines
  (`docs/ROADMAP.md` §9 records the gap).
