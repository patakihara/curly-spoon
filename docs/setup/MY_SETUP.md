...
Tick what exists: Prowlarr ☑ · Jackett ☐ · Lidarr ☑ · Readarr ☑ *(fork — "Bookshelf")* ·
Sonarr/Radarr ☑ · Jellyseerr ☑ *(as Seerr)* · slskd ☐ · Navidrome ☐ · none of these ☐
...
**This settles the open question in `HANDOVER.md` §4:** Prowlarr is present *and* already has
...
seek path is the *minority* case, and the perf worry is off by an order of magnitude in the
...
**Also worth knowing:** the box already runs *two* Jellyfin clients (Feishin for music,
