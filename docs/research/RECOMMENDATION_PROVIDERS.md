...
2. **Personal collaborative-filtering recommendations — needs the user's own account.**
   ...
   This is meaningfully better — genuinely conditioned on *her* taste, not just "fans of artist
...
artist search), but it is *Deezer's* per-artist "fans also like" list, not conditioned on
