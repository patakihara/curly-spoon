...
import net.develivarr.auralis.R
 ...
 *
 * [getDownloadManager] returns [net.develivarr.auralis.AppContainer.downloadManager] — the same
 * instance [net.develivarr.auralis.data.downloads.Media3DownloadEngine] reads from — rather than
