...
data class TrackMenuContext(
     ...
     * read directly off [net.develivarr.auralis.data.model.JellyfinTrack] carries `artistNames` but no
     * `artistId` at all, so every call site *except* [net.develivarr.auralis.features.music.AlbumDetailScreen]'s
 ...
 * [MusicPlaylistEntryUi], [net.develivarr.auralis.features.music.MusicFavoriteTrackUi]), since an
 ...
 * [net.develivarr.auralis.features.player.PlayerViewModel.musicQueue] instead of into Media3, which
