 ...
 *
 * **Replaces [net.auralis.app.features.home.HomeScreen] at this route.** It also inherits that
 ...
 * with no way to reach them. [net.auralis.app.features.home.HomeShelvesContent] and
 * [net.auralis.app.features.home.HomeViewModel] are unaffected — both stay in use by
 * [net.auralis.app.features.books.BooksScreen], which this wave does not touch.
 *
 * **Card taps**: a book or podcast card starts it playing via [playerViewModel], exactly as
 * [net.auralis.app.features.home.HomeShelvesContent] does today. A music album card navigates
