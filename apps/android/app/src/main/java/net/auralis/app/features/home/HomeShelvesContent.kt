...
/**
 * The shelf-rendering body shared by [net.auralis.app.features.home.HomeScreen] ("For you") and
 * [net.auralis.app.features.books.BooksScreen] ("Books") — wave 12a-A1 extracted this out of
...
/**
 * The four [DownloadEnqueueResult][net.auralis.app.data.downloads.DownloadEnqueueResult]
 * outcomes (via [DownloadActionState]) each get a distinct, short label — moved here from
 * `HomeScreen.kt` (wave 12a-A1) since [BooksScreen][net.auralis.app.features.books.BooksScreen]
