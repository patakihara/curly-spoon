...
class JellyfinPlaybackReporterTest {
    ...
    /**
     * The real audiobook scheme (`net.develivarr.auralis.playback.BrowseTree.BOOK_PREFIX`), not the
     ...
     * prefixed id, which is what `net.develivarr.auralis.playback.PlaybackItemResolver` really produces
